/**
 * VENUE VENDORS CLIENT APP - BROWSEVENUES.TSX
 * 
...
export default function BrowseVenues({ onApply }: Props) {
  ...
  const featuredVenues = useMemo(() => {
    return venues.filter(v => v.isFeatured && !v.isBlocked)
  }, [venues])
  ...
  return (
    <div>
      ...
      {featuredVenues.length > 0 && !search && !locFilter && !capFilter && !suitFilter && (
        <div style={{ marginBottom: '2.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            <span className="material-icons" style={{ color: '#EAB308' }}>star</span>
            <h3 style={{ margin: 0, fontSize: '1.25rem' }}>Featured Venues</h3>
          </div>
  ...
  return (
    ...
    >
      <div style={{ position: 'relative' }}>
        ...
        {venue.isFeatured && !venue.isBlocked && (
          <div
            style={{
              ...
              color: '#FDE047', fontSize: '0.7rem', fontWeight: 700,
